...
async function handler(req, res) {
  ...
  try {
    ...
    if (path === '/address-search') {
      ...
      const result = await vworld('/req/search', { service: 'search', request: 'search', version: '2.0', type: 'road', crs: 'EPSG:4326', format: 'json', errorformat: 'json', size: '10', page: '1', query: q });
